...
const strings = {
  ...
  dex_buy_tokens_enter_token_amount_to_sell: 'Enter token amount to sell here:',
  dex_buy_tokens_enter_token_amount_to_buy: 'Enter token amount to buy here:',
  dex_trade_tokens_button_title: 'Trade\nTokens',
  ...
  dex_submit_order_failure_message:'Your order submission has failed',
